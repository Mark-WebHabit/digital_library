...
const RegisterAdmin = () => {
  ...
  const pin = import.meta.env.VITE_SYSTEM_PIN;
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const { email, password, fullName, systempass, agreed } = formData;

    // Input validation
    if (!fullName || !email || !password || !systempass) {
    ...
    try {
      ...
      if (snapshot.exists()) {
        ...
        const exisingUser = Object.values(users).find((user) => {
          console.log(user);
